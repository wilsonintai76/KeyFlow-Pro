  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground hover:text-primary hover:bg-primary/5 rounded-full transition-all">
          <Pencil size={16} />
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px] rounded-3xl">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Modify the properties for this physical key.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-5 py-6">
            <div className="grid gap-2">
              <Label htmlFor="edit-name" className="font-bold text-sm">Key Identifier</Label>
              <Input
                id="edit-name"
                value={name}
            ...
            <div className="grid gap-2">
              <Label htmlFor="edit-type" className="font-bold text-sm">Category</Label>
            ...
            <div className="grid gap-2">
              <Label htmlFor="edit-location" className="font-bold text-sm">Storage Location</Label>
              <Input
                id="edit-location"
                value={location}
